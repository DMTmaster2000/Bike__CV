(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            ...
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                bodyLockToggle();
                burgerBody.classList.toggle("menu-open");
    ...
    function ibg() {
        ...
        for (var i = 0; i < ibg.length; i++) if (ibg[i].querySelector("img") && null != ibg[i].querySelector("img").getAttribute("src")) ibg[i].style.backgroundImage = "url(" + ibg[i].querySelector("img").getAttribute("src") + ")";
    }
    ibg();
    window["FLS"] = true;
    isWebp();
